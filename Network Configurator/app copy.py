...
def open_device_panel(ip):
    ...
    number_entry, status_var, output_label, operation_var = create_toggle_port_widgets(panel)
    create_status_button(panel, number_entry, status_var, output_label, operation_var, shell)
...
def create_toggle_port_widgets(panel):
    ...
    def update_widgets_visibility(event):
        if operation_var.get() == "Port állapot":
            ...
            port_number_label.pack_forget()  # Elrejtés
            port_number.pack_forget()  # Elrejtés
    ...
    return port_number, status_var, output_label, operation_var

# Port állapotát változtató gomb létrehozása
def create_status_button(panel, port_number, status_var, output_label, operation_var, shell):
